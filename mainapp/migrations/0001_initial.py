# Generated by Django 3.1.4 on 2021-01-18 16:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialisation', models.CharField(choices=[('PEDITRICIAN', 'Pediatrician'), ('GYNECOLOGIST', 'Gynecologist '), ('SURGEON', 'Surgeon'), ('PSYCHIATRIST', 'Psychiatrist'), ('CARDIOLOGIST', 'Cardiologist'), ('DERMATOLOGIST', 'Dermatologist'), ('GASTROENTEROLOGIST', 'Gastroenterologist'), ('NEPHROLOGIST', 'Nephrologist')], max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
